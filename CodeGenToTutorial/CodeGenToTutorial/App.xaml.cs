using CodeGenToTutorial.Activation;
...
using CodeGenToTutorial.Services;
using CodeGenToTutorial.ViewModels;
using CodeGenToTutorial.Views;

using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.UI.Xaml;

namespace CodeGenToTutorial;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<DiffsPage>();
            services.AddTransient<PromptViewModel>();
            services.AddTransient<PromptPage>();
